...
class Favorite extends BaseService
{
    ...
    public function getListByUser($userId)
    {
        ...
        WHERE user_id = :user_id ORDER BY favorite.created_time DESC', $parameters);
    }
    ...
    {   
        ...
        // Check if the entry that we are trying to insert already exists in "favorite" table using "IGNORE" in the SQL query
